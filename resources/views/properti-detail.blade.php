...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=MuseoModerno|Concert+One" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.7.1/css/all.min.css" integrity="sha512-5Hs3dF2AEPkpNAR7UiOHba+lRSJNeM2ECkwxUIxC1Q/FLycGTbNapWXB4tP889k5T5Ju8fs4b1P5z/iB4nMfSQ==" crossorigin="anonymous" referrerpolicy="no-referrer" />
</head>
<body>
    @include('admin.viewsAdmin')
        ...
        <div class="container">
            ...
            <div class="image-grid">
                @foreach($fotos->skip(1) as $foto)
                    <img src="{{ asset('pemilikWisata/foto/' . $foto) }}" alt="Foto" class="grid-image">
                @endforeach
            </div>
