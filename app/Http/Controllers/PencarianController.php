...
class PencarianController extends Controller
{
    public function index(Request $request)
    {
        ...
        $dataTempatWisata = [
            ...
            ['tempatwisata_id' => 5, 'nama_lokasi' => 'Candi Borobudur', 'deskripsi' => 'Candi Buddha terbesar di dunia dan warisan budaya dunia UNESCO.', 'sumir' => 'Situs bersejarah penuh makna spiritual.', 'link_foto' => 'borobudur.jpg'],
            ['tempatwisata_id' => 6, 'nama_lokasi' => 'Pantai Parangtritis', 'deskripsi' => 'Pantai terkenal di Yogyakarta dengan ombak besar dan pasir hitam yang khas.', 'sumir' => 'Ikon wisata laut selatan Yogyakarta.', 'link_foto' => 'parangtritis.jpg'],
            ...
            ['tempatwisata_id' => 13, 'nama_lokasi' => 'Gunung Bromo', 'deskripsi' => 'Gunung berapi aktif dengan pemandangan sunrise terbaik di Indonesia.', 'sumir' => 'Spot sunrise paling terkenal di Jawa Timur.', 'link_foto' => 'bromo.jpg'],
            ['tempatwisata_id' => 14, 'nama_lokasi' => 'Raja Ampat', 'deskripsi' => 'Kepulauan dengan keindahan bawah laut yang luar biasa.', 'sumir' => 'Surga snorkeling dan diving dunia.', 'link_foto' => 'rajaampat.jpg'],
            ['tempatwisata_id' => 15, 'nama_lokasi' => 'Labuan Bajo', 'deskripsi' => 'Gerbang menuju Pulau Komodo dengan panorama laut biru nan jernih.', 'sumir' => 'Destinasi eksotis untuk pencinta laut.', 'link_foto' => 'labuanbajo.jpg'],
